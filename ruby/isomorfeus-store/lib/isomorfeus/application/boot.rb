module Isomorfeus
  ...
  # Isomorfeus::Operation is already loaded it will have
  # defined these.
  class Operation
    class << self
      ...
      def receivers
        ...
        # boot will NOT be erased on the next Isomorfeus::Context.reset!
        Isomorfeus::Context.set_var(self, :@receivers, force: true) { [] }
