...
CG_NODES_EDGES = [5,2]
CG_TRANSPORT = { "graphs" => { "CombinedGraph" => { "{}" => { "edges"                => [["SimpleEdge", "2"]],
                                                              "included_arrays"      => { "simple_array" => ["SimpleArray", "{}"] },
                                                              "included_collections" => { "simple_collection" => ["SimpleCollection", "{}"] },
                                                              "included_graphs"      => { "simple_graph" => ["SimpleGraph", "{}"] },
                                                              "included_hashes"      => { "simple_hash" => ["SimpleHash", "{}"] },
                                                              "included_nodes"       => { "simple_node" => ["SimpleNode", "8"] },
                                                              "nodes"                => [["SimpleNode", "3"], ["SimpleNode", "4"]] } } } }
CG_ITEMS     = { "arrays"      => { "SimpleArray" => { "{}" => [1, 2, 3] } },
                 "collections" => { "SimpleCollection" => { "{}" => [["SimpleNode", "1"], ["SimpleNode", "2"]] } },
                 "edges"       => { "SimpleEdge" => { "1" => { "attributes" => { "simple_attribute" => "simple" }, "from" => ["SimpleNode", "1"], "to" => ["SimpleNode", "2"] },
                                                      "2" => { "attributes" => { "simple_attribute" => "simple" }, "from" => ["SimpleNode", "3"], "to" => ["SimpleNode", "4"] } } },
                 "graphs"      => { "SimpleGraph" => { "{}" => { "edges" => [["SimpleEdge", "1"]],
                                                                 "nodes" => [["SimpleNode", "1"], ["SimpleNode", "2"]] } } },
                 "hashes"      => { "SimpleHash" => { "{}" => { "simple_key" => "simple_value" } } },
                 "nodes"       => { "SimpleNode" => { "1" => { "attributes" => { "simple_attribute" => "simple" } },
...
MCG_NODES_EDGES = [8,3]
MCG_TRANSPORT = { "graphs" => { "MultiCombinedGraph" => { "{}" => { "edges"                => [["SimpleEdge", "3"]],
                                                                    "included_arrays"      => { "simple_array" => ["SimpleArray", "{}"] },
                                                                    "included_collections" => { "simple_collection" => ["SimpleCollection", "{}"] },
                                                                    ...
                                                                    "nodes"                => [["SimpleNode", "5"], ["SimpleNode", "6"]] } } } }
MCG_ITEMS     = { "arrays"      => { "SimpleArray" => { "{}" => [1, 2, 3] } },
                  "collections" => { "SimpleCollection" => { "{}" => [["SimpleNode", "1"], ["SimpleNode", "2"]] } },
                  "edges"       => { "SimpleEdge" => { "1" => { "attributes" => { "simple_attribute" => "simple" }, "from" => ["SimpleNode", "1"], "to" => ["SimpleNode", "2"] },
                                                       "2" => { "attributes" => { "simple_attribute" => "simple" }, "from" => ["SimpleNode", "3"], "to" => ["SimpleNode", "4"] },
                                                       "3" => { "attributes" => { "simple_attribute" => "simple" }, "from" => ["SimpleNode", "5"], "to" => ["SimpleNode", "6"] } } },
                  "graphs"      => { "CombinedGraph" => { "{}" => { "edges"                => [["SimpleEdge", "2"]],
                                                                    "included_arrays"      => { "simple_array" => ["SimpleArray", "{}"] },
                                                                    "included_collections" => { "simple_collection" => ["SimpleCollection", "{}"] },
                                                                    "included_graphs"      => { "simple_graph" => ["SimpleGraph", "{}"] },
                                                                    "included_hashes"      => { "simple_hash" => ["SimpleHash", "{}"] },
                                                                    "included_nodes"       => { "simple_node" => ["SimpleNode", "8"] },
                                                                    "nodes"                => [["SimpleNode", "3"], ["SimpleNode", "4"]] } },
                                     "SimpleGraph"   => { "{}" => { "edges" => [["SimpleEdge", "1"]],
                                                                    "nodes" => [["SimpleNode", "1"], ["SimpleNode", "2"]] } } },
                  "hashes"      => { "SimpleHash" => { "{}" => { "simple_key" => "simple_value" } } },
                  "nodes"       => { "SimpleNode" => { "1" => { "attributes" => { "simple_attribute" => "simple" } },
                                                       "2" => { "attributes" => { "simple_attribute" => "simple" } },
