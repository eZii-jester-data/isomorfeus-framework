...
describe 'React Integration', js: true do
  it "The isomorfeus-component gem can use Isomorfeus::Component to create components" do
    mount "TestComp" do
      class TestComp < Isomorfeus::Component
        render(DIV) { 'hello'}
      end
    end
  ...
  it "The isomorfeus-component gem can use Isomorfeus::Component::Mixin to create components" do
    mount "TestComp" do
      class TestComp
  ...
  it "The isomorfeus-component gem can use the deprecated React::Component::Base class to create components" do
    mount "TestComp" do
    ...
    ["Warning: Deprecated feature used in TestComp. The class name React::Component::Base has been deprecated.  Use Isomorfeus::Component instead."]
    )
  end
  it "The isomorfeus-component gem can use Isomorfeus::Component::Mixin to create components" do
    mount "TestComp" do
    ...
    expect(page).to have_content('hello')
    expect_evaluate_ruby("React::Component.instance_variable_get('@deprecation_messages')").to eq(
    ["Warning: Deprecated feature used in TestComp. The module name React::Component has been deprecated.  Use Isomorfeus::Component::Mixin instead."]
    )
  end
  it "The isomorfeus-component gem can use isomorfeus-store state syntax" do
    mount "TestComp" do
      class TestComp < Isomorfeus::Component
        before_mount do
          mutate.foo 'hello'
  ...
  it "can use the isomorfeus-store syntax to declare component states" do
    mount "TestComp" do
      class TestComp < Isomorfeus::Component
        state foo: 'hello'
        render(DIV) do
  ...
  it "can use the isomorfeus-store syntax to declare component states and use deprecated mutate syntax" do
    mount "TestComp" do
      class TestComp < Isomorfeus::Component
        state foo: true
        after_mount do
  ...
  it "can use the isomorfeus-store syntax to declare class states" do
    mount "TestComp" do
      class TestComp < Isomorfeus::Component
