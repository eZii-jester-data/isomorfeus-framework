...
describe 'React::Callbacks', js: true do
  ...
  context 'using Isomorfeus::Context.reset!' do
    #after(:all) do
    #  Isomorfeus::Context.instance_variable_set(:@context, nil)
    #end
    it 'clears callbacks on Isomorfeus::Context.reset!' do
      on_client do
        Isomorfeus::Context.reset!
