    ...
    module Mixin
      ...
      def update_react_js_state(object, name, value)
        if object
          ...
          # this way notifactions will happen as expected by the rest of isomorfeus
          set_state(
...
module React
  module Component
    def self.included(base)
      ...
      deprecation_warning base, "The module name React::Component has been deprecated.  Use Isomorfeus::Component::Mixin instead."
