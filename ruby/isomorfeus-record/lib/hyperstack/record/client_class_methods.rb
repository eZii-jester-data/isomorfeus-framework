module Isomorfeus
  module Record
    module ClientClassMethods
          ...
          if @properties[:id]
            ...
            if @properties[name].nil?
              ...
              if self.class._property_options[name].has_key?(:default)
                ...
                Isomorfeus::Record::DummyValue.new(self.class._property_options[name][:type])
              else
                Isomorfeus::Record::DummyValue.new(NilClass)
              end
            else
              @properties[name]
            end
      ...
      # macro define rest_class_methods, RPC on class level of current Isomorfeus::Record class
      #
      # @param name [Symbol] name of method
      ...
      # macro define rest_class_methods, RPC on instance level of a record of current Isomorfeus::Record class
      #
      # @param name [Symbol] name of method
      # @param options [Hash] with known keys:
      #   default_result: result to present during render during method call in progress
