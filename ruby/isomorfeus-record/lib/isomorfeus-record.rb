...
if RUBY_ENGINE == 'opal'
  ...
  require 'isomorfeus/record/ruby/class_methods'
  require 'isomorfeus/record/ruby/relations'
  require 'isomorfeus/record/ruby/remote_methods'
  require 'isomorfeus/record/ruby/scopes'
  require 'isomorfeus/record/ruby/instance_methods'
  require 'isomorfeus/record/common_instance_methods'
  require 'lucid_record/mixin'
  require 'lucid_record/base'
