      ...
      module Scopes
        ...
        def scope(name, _options = {})
          ...
          define_singleton_method("promise_#{name}") do |*args|
            Isomorfeus::DataAccess.promise_fetch('isomorfeus/handler/model/read', self.model_name, :scopes, name, args).then do |response|
          ...
          define_singleton_method(name) do |*args|
            Isomorfeus::DataAccess.register_used_store_path(:record_state, self.model_name, :scopes, name, args)
            result = Isomorfeus::DataAccess.local_fetch(:record_state, self.model_name, :scopes, name, args)
